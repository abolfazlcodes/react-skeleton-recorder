      ...
      <section className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        <header className="space-y-2">
          ...
          <p className="text-gray-600 max-w-2xl">
            Everything you need to install, configure, and use React Skeleton
            Recorder.
          </p>
        </header>
        ...
        <section className="bg-white border rounded-xl p-6 shadow-sm space-y-3">
          ...
          <div className="grid md:grid-cols-3 gap-3 text-xs">
            <code className="rounded-md bg-gray-900 text-gray-50 px-3 py-2 block">
      ...
      <div className="card">
        ...
        <section className="bg-white border rounded-xl p-6 shadow-sm space-y-3">
          ...
          <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
            <li>
              <code>isLoading?: boolean</code> — shows the generated skeleton
              when true.
            </li>
            <li>
              <code>devMode?: boolean</code> — adds a floating &quot;📸 Capture
              Skeleton&quot; button for local inspection.
            </li>
            <li>
              <code>onCapture?: (jsx: React.ReactNode) =&gt; void</code> —
              receive captured JSX when clicking the button.
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white border rounded-xl p-6 shadow-sm space-y-4">
          ...
          <p className="text-sm text-gray-700">
            Set the CSS variable <code>--skeleton-base-color</code> globally.
            You can also control light/dark by toggling
...
:root[data-theme="dark"]  { --skeleton-base-color: #374151; }`}
          ...
          <p className="text-xs text-gray-600">
            Motion is disabled automatically when users enable{" "}
        ...
        <section className="bg-white border rounded-xl p-6 shadow-sm space-y-3">
          ...
          <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
            ...
            <li>
              Mirrors layout (flex/grid, gaps, padding, radius) with lightweight
              blocks.
            </li>
            <li>
              Text nodes become ragged lines; media becomes blocks or circles.
            </li>
            <li>
              Injects a minimal <code>@keyframes pulse</code> once per document.
            </li>
          </ul>
        </section>
      </section>
