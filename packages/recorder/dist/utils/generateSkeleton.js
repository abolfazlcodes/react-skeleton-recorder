...
export const generateSkeleton = (element, parentRect) => {
    ...
    if (isLeaf) {
        ...
        if (hasTextContent && !isButtonLike && !isImageLike && height > 0 && width > 0) {
            ...
            return _jsx("div", { "aria-hidden": "true", style: textContainer, children: lines });
        }
        if (isAbsolutelyPositioned && parentRect) {
        ...
        return _jsx("div", { "aria-hidden": "true", style: leafStyles });
    }
    ...
    return (_jsx("div", { "aria-hidden": "true", style: containerStyles, children: children.map((child, i) => (_jsx(React.Fragment, { children: generateSkeleton(child, rect) }, i))) }));
};
